...
public class Duration extends Message {
	...
	private final org.jrosbridge.springed.primitives.Duration data;

	/**
	 * Create a new Duration with a default of 0.
	 */
	public Duration() {
		this(new org.jrosbridge.springed.primitives.Duration());
	}
	 ...
	 */
	public Duration(org.jrosbridge.springed.primitives.Duration data) {
	 ...
	 */
	public org.jrosbridge.springed.primitives.Duration getData() {
		return this.data;
	}
	...
	public static Duration fromJsonObject(JsonObject jsonObject) {
		// check the fields
		org.jrosbridge.springed.primitives.Duration data = jsonObject
				.containsKey(Duration.FIELD_DATA) ? org.jrosbridge.springed.primitives.Duration
				.fromJsonObject(jsonObject.getJsonObject(Duration.FIELD_DATA))
				: new org.jrosbridge.springed.primitives.Duration();
