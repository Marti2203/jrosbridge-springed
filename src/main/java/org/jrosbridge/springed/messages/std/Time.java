...
public class Time extends Message {
	...
	private final org.jrosbridge.springed.primitives.Time data;

	/**
	 * Create a new Time with a default of 0.
	 */
	public Time() {
		this(new org.jrosbridge.springed.primitives.Time());
	}
	 ...
	 */
	public Time(org.jrosbridge.springed.primitives.Time data) {
	 ...
	 */
	public org.jrosbridge.springed.primitives.Time getData() {
		return this.data;
	}
	...
	public static Time fromJsonObject(JsonObject jsonObject) {
		// check the fields
		org.jrosbridge.springed.primitives.Time data = jsonObject
				.containsKey(Time.FIELD_DATA) ? org.jrosbridge.springed.primitives.Time
				.fromJsonObject(jsonObject.getJsonObject(Time.FIELD_DATA))
				: new org.jrosbridge.springed.primitives.Time();
