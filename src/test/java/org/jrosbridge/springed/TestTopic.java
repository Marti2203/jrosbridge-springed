...
//		assertEquals(ROSConstants.CompressionType.none, t1.getCompression());
...
//		assertEquals(ROSConstants.CompressionType.png, t2.getCompression());
...
//		assertEquals(ROSConstants.CompressionType.none, t3.getCompression());
...
//		assertEquals(ROSConstants.CompressionType.png, t4.getCompression());
...
//								+ ROSConstants.OP_CODE_PUBLISH + "\",\""
//								+ ROSConstants.FIELD_TOPIC + "\":\"myTopic1\",\""
//								+ ROSConstants.FIELD_MESSAGE
//								+ "\":{\"test1\":\"test2\"}}").build());
//
