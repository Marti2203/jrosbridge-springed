package org.jrosbridge.springed.messages.actionlib;
...
import org.jrosbridge.springed.messages.std.Header;
import org.jrosbridge.springed.primitives.Time;
...
public class TestGoalStatusArray {
	...
	public void testConstructor() {
		Assert.assertEquals(new Header(), empty.getHeader());
		assertTrue(Arrays
	...
	public void testHeaderAndGoalStatusConstructor() {
		Assert.assertEquals(new Header(123, new Time(10, 20), "test"), g1.getHeader());
	...
	public void testClone() {
		...
		Assert.assertEquals(g1.getHeader(), clone.getHeader());
	...
	public void testFromJsonString() {
		...
		Assert.assertEquals(g1.getHeader(), p.getHeader());
	...
	public void testFromJsonObjectNoHeader() {
		...
		assertEquals(g1.getMessageType(), p.getMessageType());
		assertEquals(g1.size(), p.size());
		Assert.assertEquals(new Header(), p.getHeader());
		assertTrue(Arrays.deepEquals(g1.getStatusList(), p.getStatusList()));
		assertNotSame(g1, p);
		assertNotSame(g1.toString(), p.toString());
		assertNotSame(g1.toJsonObject(), p.toJsonObject());
