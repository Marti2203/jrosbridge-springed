package org.jrosbridge.springed.messages.geometry;
...
public class TestVector3Stamped {
	...
	public void testHeaderAndVector3Constructor() {
		Assert.assertEquals(new Header(123, new Time(10, 20), "test"), v1.getHeader());
	...
	public void testClone() {
		...
		Assert.assertEquals(v1.getHeader(), clone.getHeader());
	...
	public void testFromJsonString() {
		...
		Assert.assertEquals(v1.getHeader(), p.getHeader());
