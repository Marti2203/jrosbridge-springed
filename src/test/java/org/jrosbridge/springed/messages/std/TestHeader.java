...
import org.jrosbridge.springed.primitives.Primitive;
...
public class TestHeader {
	...
	public void setUp() {
		empty = new Header();
		h1 = new Header(5, new Time(10, 20),
				"test");
	}
	...
	public void testIntTimeAndStringConstructorNegative() {
		Header h = new Header(-1, new Time(
				10, 20), "test");
