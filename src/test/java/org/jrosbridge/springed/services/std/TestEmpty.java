package org.jrosbridge.springed.services.std;
...
public class TestEmpty {
	...
	public void testRequestConstructor() {
		...
		Assert.assertEquals(Empty.TYPE, emptyReq.getServiceRequestType());
	}

	@Test
	public void testRequestServiceRequestType() {
		emptyReq.setServiceRequestType("test");
		Assert.assertEquals("test", emptyReq.getServiceRequestType());
	}
	...
	public void testRequestClone() {
		...
		Assert.assertEquals(emptyReq.getServiceRequestType(),
	...
	public void testResponseConstructor() {
		...
		Assert.assertEquals(Empty.TYPE, emptyResp.getServiceResponseType());
	}

	@Test
	public void testResponseServiceResponseType() {
		emptyResp.setServiceResponseType("test");
		Assert.assertEquals("test", emptyResp.getServiceResponseType());
	}
	...
	public void testResponseClone() {
		...
		Assert.assertEquals(emptyResp.getServiceResponseType(),
